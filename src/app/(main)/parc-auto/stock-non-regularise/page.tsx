...
export default function StockNonRegularisePage() {
  ...
  useEffect(() => {
    ...
    vehiclesApi
      ...
      .catch((e) => {
        if (!cancelled)
          setError(e instanceof Error ? e.message : "Erreur chargement stock non régularisé");
      })
      .finally(() => {
    ...
    <div className="space-y-8">
      <div>
        ...
        <p className="mt-1 text-slate-500">
          Véhicules en attente de régularisation : client a payé en partie ou paiement en cours selon la compta.
        </p>
      </div>
          ...
          <>
            ...
            {vehicles.length === 0 && (
              <p className="py-12 text-center text-slate-500">
                Aucun véhicule en stock non régularisé.
              </p>
            )}
          </>
        )}
